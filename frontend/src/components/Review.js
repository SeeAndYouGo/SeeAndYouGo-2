    ...
    return(
        <ReviewWriteContainer>
            <div style={{width: '100%', float: 'left'}}>
                ...
                <ReviewStarRating>
                    <StarsRating value={starVal} onChange={value => {setStarVal(value)}} />
                </ReviewStarRating>
            </div>
            <div style={{width: '100%'}}>
    ...
    return(
        <ReviewItemContainer>
            ...
            <div className="Row3" style={{width: '100%', float:'left'}}>
                <img src={img} style={{maxHeight: 120, float:'left', marginTop: 5}}></img>
            </div>
        </ReviewItemContainer>
    );
}
...
const Review = () => {
    return(
        <div style={{float: 'left', marginTop: 20}}>
            ...
            <ReviewWrite />
            <ReviewItem user={'익명1'} time={20} rate={5} content={'맵지만 맛있게 먹었다 !'} img={"/assets/images/menu1.jpg"} />
            <ReviewItem user={'익명2'} time={55} rate={4} content={'닭갈비 은근 양 많다'} />
